...
public class TaskmsApplicationTests {
	...
	public void testPostDetails() throws Exception {
		...
		HttpHeaders headers = new HttpHeaders();
		HttpEntity<String> entity = new HttpEntity<String>(null, headers);
		ResponseEntity<String> response = restTemplate.exchange(getRootUrl() + "/postdetails", HttpMethod.POST, entity,
				String.class);
		assertNotNull(response.getBody());
	}
	...
	public void testPutDetails() throws Exception {
		HttpHeaders headers = new HttpHeaders();
		HttpEntity<String> entity = new HttpEntity<String>(null, headers);
		ResponseEntity<String> response = restTemplate.exchange(getRootUrl() + "/putdetails", HttpMethod.PUT, entity,
				String.class);
		assertNotNull(response.getBody());
	}
	...
	public void testPostEmployee() throws Exception {
		...
		HttpHeaders headers = new HttpHeaders();
		HttpEntity<String> entity = new HttpEntity<String>(null, headers);
		ResponseEntity<String> response = restTemplate.exchange(getRootUrl() + "/postemployee", HttpMethod.POST, entity,
				String.class);
		assertNotNull(response.getBody());
	}
	...
	public void testPutEmployee() throws Exception {
		HttpHeaders headers = new HttpHeaders();
		HttpEntity<String> entity = new HttpEntity<String>(null, headers);
		ResponseEntity<String> response = restTemplate.exchange(getRootUrl() + "/putemployee", HttpMethod.PUT, entity,
				String.class);
		assertNotNull(response.getBody());
	}
